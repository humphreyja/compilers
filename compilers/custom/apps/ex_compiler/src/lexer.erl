...
yystate(89, [32|Ics], Line, Tlen, _, _) ->
    yystate(89, Ics, Line, Tlen+1, 42, Tlen);
...
yystate(87, [119|Ics], Line, Tlen, Action, Alen) ->
...
yystate(87, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(55, Ics, Line, Tlen+1, Action, Alen);
yystate(87, [C|Ics], Line, Tlen, Action, Alen) when C >= 106, C =< 110 ->
    yystate(55, Ics, Line, Tlen+1, Action, Alen);
yystate(87, [C|Ics], Line, Tlen, Action, Alen) when C >= 120, C =< 122 ->
    yystate(55, Ics, Line, Tlen+1, Action, Alen);
...
yystate(82, [101|Ics], Line, Tlen, _, _) ->
    yystate(78, Ics, Line, Tlen+1, 43, Tlen);
...
yystate(75, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(55, Ics, Line, Tlen+1, 43, Tlen);
yystate(75, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 103 ->
    yystate(55, Ics, Line, Tlen+1, 43, Tlen);
...
yystate(61, [61|Ics], Line, Tlen, _, _) ->
    yystate(65, Ics, Line, Tlen+1, 37, Tlen);
yystate(61, Ics, Line, Tlen, _, _) ->
    {37,Tlen,Ics,Line,61};
yystate(60, [108|Ics], Line, Tlen, _, _) ->
    yystate(64, Ics, Line, Tlen+1, 43, Tlen);
...
yystate(58, [112|Ics], Line, Tlen, _, _) ->
    yystate(55, Ics, Line, Tlen+1, 43, Tlen);
yystate(58, [113|Ics], Line, Tlen, _, _) ->
    yystate(55, Ics, Line, Tlen+1, 43, Tlen);
...
yystate(50, [97|Ics], Line, Tlen, _, _) ->
    yystate(46, Ics, Line, Tlen+1, 43, Tlen);
...
yystate(47, Ics, Line, Tlen, _, _) ->
    {43,Tlen,Ics,Line,47};
yystate(46, [107|Ics], Line, Tlen, _, _) ->
...
yystate(46, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(55, Ics, Line, Tlen+1, 43, Tlen);
yystate(46, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 106 ->
    yystate(55, Ics, Line, Tlen+1, 43, Tlen);
yystate(46, [C|Ics], Line, Tlen, _, _) when C >= 108, C =< 122 ->
    yystate(55, Ics, Line, Tlen+1, 43, Tlen);
yystate(46, Ics, Line, Tlen, _, _) ->
    {43,Tlen,Ics,Line,46};
yystate(45, [61|Ics], Line, Tlen, _, _) ->
    yystate(49, Ics, Line, Tlen+1, 31, Tlen);
...
yystate(35, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 113 ->
    yystate(55, Ics, Line, Tlen+1, 43, Tlen);
yystate(35, [C|Ics], Line, Tlen, _, _) when C >= 115, C =< 120 ->
    yystate(55, Ics, Line, Tlen+1, 43, Tlen);
...
yystate(31, [112|Ics], Line, Tlen, _, _) ->
    yystate(27, Ics, Line, Tlen+1, 43, Tlen);
...
yystate(28, [116|Ics], Line, Tlen, _, _) ->
    yystate(32, Ics, Line, Tlen+1, 43, Tlen);
...
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 101 ->
    yystate(55, Ics, Line, Tlen+1, 43, Tlen);
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 103, C =< 109 ->
    yystate(55, Ics, Line, Tlen+1, 43, Tlen);
...
yystate(15, [101|Ics], Line, Tlen, _, _) ->
    yystate(11, Ics, Line, Tlen+1, 43, Tlen);
...
-file("src/lexer.xrl", 73).
yyaction_20(TokenLine) ->
     { token, { void, TokenLine } } .
...
-file("src/lexer.xrl", 76).
yyaction_22(TokenLine) ->
     { token, { '<=', TokenLine } } .

-compile({inline,yyaction_23/1}).
-file("src/lexer.xrl", 77).
yyaction_23(TokenLine) ->
     { token, { '>=', TokenLine } } .
...
-file("src/lexer.xrl", 81).
yyaction_27(TokenLine) ->
     { token, { '!', TokenLine } } .

-compile({inline,yyaction_28/1}).
-file("src/lexer.xrl", 82).
yyaction_28(TokenLine) ->
     { token, { '=', TokenLine } } .
